# from merkle import merkle_tree, mk_multi_proof, verify_multi_proof
...
#             tree[1], indices, [leaves[i] for i in indices], 4, proof
#         )
#         if i % 1024 == 1023:
#             print("%d of 65536 16-element proofs checked" % (i + 1))
#             assert not verify_multi_proof(
#                 tree[2], indices, [leaves[i] for i in indices], 4, proof
#             )
#             assert not verify_multi_proof(
#                 tree[1], indices, [leaves[i][::-1] for i in indices], 4, proof
#             )
